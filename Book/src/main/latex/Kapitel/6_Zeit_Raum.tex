...
Aber das ist nur der Anfang. Die wahre Frage ist: Existiert die Zeit \emph{überhaupt} als objektive Realität? Oder ist sie nur eine Konstruktion unseres Gehirns, eine Art „Film", den wir abspulen, um die Welt verstehbar zu machen?
...
Aber hier wird es philosophisch interessant: Wenn Zeit eine Dimension ist, dann existiert die Zukunft genauso wie die Vergangenheit. Wir bewegen uns nicht durch die Zeit – wir \emph{bewegen uns} in ihr, wie wir uns durch den Raum bewegen. Das würde bedeuten, dass alles, was je geschehen ist und je geschehen wird, irgendwie „da draußen" ist.

Dies ist die Sicht der \emph{Blockzeit}: Die Vergangenheit, Gegenwart und Zukunft existieren gleichzeitig. Was wir „Gegenwart" nennen, ist nur unser momentaner Standpunkt in dieser vierdimensionalen Struktur.

\begin{defi}[Blockzeit]
	Das philosophische Konzept, dass Zeit nicht „fließt", sondern als vierte Dimension erstarrt ist. Vergangenheit, Gegenwart und Zukunft existieren gleichzeitig in einer zeitlosen Struktur.
\end{defi}
...
Eine der tiefsten Fragen der Philosophie: Was ist das \emph{Ich}? Wer ist dieses „Ich", das diese Zeilen liest? Ist es ein konstantes, permanentes Wesen – eine Seele, ein Selbst, ein Subjekt, das die Jahre überdauert?

Oder ist das Ich ein \emph{Prozess}, ein Fluss, ein ständiges Werden? Der Philosoph Heraklit sagte: \emph{„Panta rhei"} – alles fließt. Nichts bleibt. Das Ich, das du heute bist, ist nicht dasselbe wie das Ich von gestern oder morgen. Es ist ein \emph{Strom} von Erfahrungen, nicht ein fester Kern.
...
\begin{bsp}[Das Selbst wie eine Flamme]
	Das Ich ist wie eine Flamme: Sie bleibt „gleich", während die Materie, aus der sie besteht, ständig fließt. Ebenso bleibt das „Ich" konstant, während die Gedanken, Gefühle und körperlichen Zellen ständig wechseln.
\end{bsp}
